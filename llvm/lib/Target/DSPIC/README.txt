...
for libcalls is incomptible with calling convention of libcalls of dspic-gcc
...
10. Handle imm in comparisons in better way (see comment in DSPICInstrInfo.td)
